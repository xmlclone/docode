    ...
    <div style="width:100%; float:left; margin-top:30px; margin-left:50px"> 
        <table cellspacing="0" cellpadding="4" border="1" align="left">  
            <thead>
                ...
                <td style="text-align:center; color:#FF3333" colspan="5" bgcolor="#F3F3F3"><b>失败用例列表</b></td>
                <tr bgcolor="#F3F3F3">  
                    <td colspan="2"><b>测试用例</b></td>  
                    <td colspan="2"><b>错误描述</b></td>
                </tr>
            </thead>  
            <tbody>  
<% 
...
%>
                <tr>  
                    <td colspan="2"><%= suiteName + "." + tc.displayName %></td>    
<% 
                            if(tc.errorMsg != null) { //5
%>
                    <td colspan="2"><span style="font-size:10px"><%= tc.errorMsg%></span></td>
                </tr>
<%
                            } //5
%>
